...
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit outline-1 :foreground "red" :weight bold :height 1.0))))
 '(org-level-2 ((t (:foreground "green" :height 1.0))))
 '(org-level-3 ((t (:foreground "yellow" :height 1.0))))
 '(org-level-4 ((t (:foreground "blue" :height 1.0))))
